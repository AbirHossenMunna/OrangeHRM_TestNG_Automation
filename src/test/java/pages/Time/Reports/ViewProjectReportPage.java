...
public class ViewProjectReportPage {
    int length;
    @FindBy(tagName = "a")
    ...
    public ViewProjectReportPage(WebDriver driver) {
    ...
    public String projectReportByInvalidProjectName(String name) throws InterruptedException {
        Thread.sleep(2000);
    ...
    public String projectReportByInvalidDateRange(String name) throws InterruptedException {
        ...
        Thread.sleep(2000);
        txtInputField.get(2).sendKeys("2024-15-10");
        Thread.sleep(2000);
        txtInputField.get(3).sendKeys("2024-04-10");
        Thread.sleep(2000);
        btnView.get(4).click();
        return lblErrorMsg.getText();
    }

    public String viewProjectReportByMandatoryField() throws InterruptedException {
